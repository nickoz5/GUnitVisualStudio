...
namespace UnitTestProject.MyToolWindowTest
{
	...
	public class ShowToolWindowTest
	{
		...
		{
			IVsPackage package = new GUnitPackage() as IVsPackage;
			...
			MethodInfo method = typeof(GUnitPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
